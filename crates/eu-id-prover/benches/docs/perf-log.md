...
| 2026-07-06 | f286d3c9 | mdoc Phase D in-circuit MSO bindings | `mdoc_perf_probe` prove (BENCH_ITERS=1, RAYON_NUM_THREADS=1, release) | — | 1160 ms |
| 2026-07-06 | f286d3c9 | mdoc Phase D in-circuit MSO bindings | `mdoc_perf_probe` verify (BENCH_ITERS=1, RAYON_NUM_THREADS=1, release) | — | 50 ms |
| 2026-07-06 | f286d3c9 | mdoc Phase D in-circuit MSO bindings | mdoc proof bytes | — | 2,441,494 |
| 2026-07-06 | f286d3c9 | mdoc Phase D in-circuit MSO bindings | mdoc committed shape cells | — | 7,617,136 |
...
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity (Criterion, RAYON_NUM_THREADS=1, security=128) | mdoc/prove/longfellow_mdl3_N1_prod128 | — | 1.1339 s |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity (Criterion, RAYON_NUM_THREADS=1, security=110) | mdoc/prove/longfellow_mdl3_N1_parity110 | — | 1.1528 s |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity (Criterion, RAYON_NUM_THREADS=1, security=128) | mdoc/prove/longfellow_mdl3_N2_prod128 | — | 1.3137 s |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity (Criterion, RAYON_NUM_THREADS=1, security=110) | mdoc/prove/longfellow_mdl3_N2_parity110 | — | 1.3097 s |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity (Criterion, RAYON_NUM_THREADS=1, security=128) | mdoc/verify/longfellow_mdl3_N1_prod128 | — | 42.221 ms |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity (Criterion, RAYON_NUM_THREADS=1, security=110) | mdoc/verify/longfellow_mdl3_N1_parity110 | — | 41.539 ms |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity (Criterion, RAYON_NUM_THREADS=1, security=128) | mdoc/verify/longfellow_mdl3_N2_prod128 | — | 45.175 ms |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity (Criterion, RAYON_NUM_THREADS=1, security=110) | mdoc/verify/longfellow_mdl3_N2_parity110 | — | 44.034 ms |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity | longfellow_mdl3_N1 proof bytes, 128 -> 110 security | 2,283,994 | 2,084,934 |
| 2026-07-06 | worktree | mdoc P3 Longfellow vector parity | longfellow_mdl3_N2 proof bytes, 128 -> 110 security | 2,738,362 | 2,482,182 |
| 2026-07-06 | worktree | mdoc P3 Longfellow EUAV vector (Criterion, RAYON_NUM_THREADS=1, security=128) | mdoc/prove/longfellow_euav11_N1_prod128 | — | 876.81 ms |
| 2026-07-06 | worktree | mdoc P3 Longfellow EUAV vector (Criterion, RAYON_NUM_THREADS=1, security=110) | mdoc/prove/longfellow_euav11_N1_parity110 | — | 878.90 ms |
...
(Apache-2.0), regenerated by `tools/extract_longfellow_vectors.py`. The
production EUDI request remains ISO 18013-5 `DeviceAuthenticationBytes`; the
Longfellow vector requests use an explicit `LongfellowLegacy` compatibility
mode because Longfellow's own `compute_transcript_hash` appends
`DeviceNameSpacesBytes` as a tag-24 data item inside the
`DeviceAuthentication` array. Criterion commands:
`RAYON_NUM_THREADS=1 cargo bench -p eu-id-prover --bench mdoc_bench -- longfellow_mdl3`
and `... -- longfellow_euav11`. Release e2e gates also passed for mDL N=1,
