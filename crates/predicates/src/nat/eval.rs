...
pub struct NationalityEval {
    ...
    /// Number of entries in the complete signed nationality array.
...
impl FrameworkEval for NationalityEval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        let active = eval.get_preprocessed_column(active_col_id(self.nationality_count));
        let row_index = eval.get_preprocessed_column(row_index_col_id(self.nationality_count));
        let first = eval.get_preprocessed_column(first_col_id(self.nationality_count));
        let last = eval.get_preprocessed_column(last_col_id(self.nationality_count));
