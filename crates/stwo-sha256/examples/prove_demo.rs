...
//! eventual benchmark target `cargo run --release -p stwo-sha256 --bin
//! eu-id` (roadmap 3.13) is what replaces this example with a real CLI.
//!
...
fn main() -> ExitCode {
    ...
    eprintln!(
        "prove_sha256({:?}) — {} byte(s), default ProverConfig (log_n_rows={}, group_width={})",
